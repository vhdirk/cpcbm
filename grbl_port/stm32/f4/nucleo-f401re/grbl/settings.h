...
#define EFLASH_ERASE_RESTORE_MAIN         (EFLASH_MAIN_BASE_ADDRESS + EFLASH_ERASE_AND_RESTORE_OFFSET)
...
#define EFLASH_ERASE_RESTORE_COPY         (EFLASH_COPY_BASE_ADDRESS + EFLASH_ERASE_AND_RESTORE_OFFSET) //likely unuseful
#else
